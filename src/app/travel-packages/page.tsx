      ...
      <section className="relative h-64 md:h-80">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="text-white">
            <h1 className="text-3xl md:text-5xl font-bold mb-4">Bali our Package</h1>
            <p className="text-lg md:text-xl opacity-90">Explore the best tour packages in Bali</p>
          </div>
        </div>
      </section>

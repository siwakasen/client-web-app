"use client"
import { TravelPackagesMeta, TravelPackages } from "@/_interfaces/travel-packages.interface"
...
export default function MainContent({tourPackages: initialTourPackages, meta: initialMeta}: TourPackagesProps) {
    ...
    const filteredPackages = useMemo(() => {
        return tourPackages.filter((pkg: TravelPackages) => {
            const matchesMaxPrice = !maxPrice || pkg.package_price <= Number.parseInt(maxPrice)
            const matchesGroupSize = !maxGroupSize || pkg.max_persons <= Number.parseInt(maxGroupSize)

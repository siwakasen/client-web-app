    ...
    <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-8">Meet Our Manager</h2>
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-gray-700 text-lg leading-relaxed max-w-3xl mx-auto">
              With over 15 years of industry experience, Agung leads our company with vision and 
              innovation. His commitment to excellence and sustainable practices has transformed how we 
              approach business in the modern era.
            </p>
          </div>
        </div>
